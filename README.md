...
#### ⚡ Скорости (символов в секунду)

| Параметр | Описание | По умолчанию | Диапазон |
|----------|----------|--------------|----------|
| `printSpeed` | Скорость печати | `10` | `0.1` - `100` |
| `eraseSpeed` | Скорость стирания | `10` | `0.1` - `100` |
| `delayBetweenLines` | Задержка между строками (ms) | `800` | `0` - `5000` |
