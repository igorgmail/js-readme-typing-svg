...
|----------|----------|----------|--------|
| `lines` | Строки текста (разделитель `;`) | `string` | `Hello;World` |
...
|----------|----------|----------|--------|
| `horizontalAlign` | Горизонтальное | `left`, `center`, `right` | `center` |
| `verticalAlign` | Вертикальное | `top`, `middle`, `bottom` | `middle` |
| `center` | Центрировать по обеим осям | `true` / `false` | `true` |
...
- 📅 [Работа с переменными](docs/VARIABLES.md) — подробное описание `$DATE` и `$RELDATE`
...
- [whiteSHADOW1234/TypingSVG](https://github.com/whiteSHADOW1234/TypingSVG) — другая реализация
